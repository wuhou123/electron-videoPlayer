  ...
  <v-app-bar app clipped-left height="52px" flat class="app-top-bar">
    <v-row class="drag">
      ...
      <div
        ...
        v-if="loginState"
        @click="userInfoVisiable = !userInfoVisiable"
        ref="attached-dialog-wrapper"
      >
          ...
          <div class="info-wrapper">
            <v-container fluid class="mt-2 border-b">
              <v-row align="center">
                ...
                <v-col>
                  <span class="subtitle-2 grey--text text--lighten-2">{{
                    userInfo.nickname
                  }}</span>
                </v-col>
                <v-btn
                  class="mr-3 grey--text caption"
                  width="60"
                  height="22"
                  depressed
                  outlined
                  @click="handleDailySign"
            ...
            >
              <i
                class="iconfont icon-logout grey--text text--darken-1 mr-2"
              ></i>
              <span class="caption">注销登录</span>
            </v-btn>
          </div>
        </base-attached-dialog>
      </div>
      ...
      <div class="window-btn-group grey--text mr-2 no-drag">
        ...
        ></i>
        <i
          class="iconfont icon-unmaxisize"
          @click="restoreWindow"
          v-show="windowMaximized"
        ></i>
